...
public static function rp_sendsms($source,$destination,$message,$type){
	...
	echo '
<form id="my_sms" action="https://www.circlefundgh.com/api/reply/sms/" method="GET" target="hidden-form">
...
public static function rp_sendmail($to,$subject,$message,$header){
