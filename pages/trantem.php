            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default" id="account">
                        <div class="panel-heading">
                            <i class="fa fa-profile fa-fw"></i> Add Transactions
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="list-group">
                                ...
                                <div class="list-group-item">
                                  <input class="form-control" value="Submit" name="submit" type="submit" autofocus autocomplete="off">
                                </div>
                        ...
                        <div class="panel-body">
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <!-- <i class="fa fa-comment fa-fw"></i> -- TRIFT SAVINGS PLAN
                                    <span class="pull-right text-muted small"><em>Investment Plan</em>
                                    </span>
                                </a> 
                                <a href="#" class="list-group-item">
                                    <!-- <i class="fa fa-envelope fa-fw"></i> -- XX XX XX XX X7 14
                                    <span class="pull-right text-muted small"><em>Account Number</em>
                                    </span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <!-- <i class="fa fa-twitter fa-fw"></i> -- $2,007,885.00
