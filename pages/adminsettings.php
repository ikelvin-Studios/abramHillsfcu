...
if (isset($_POST['up_submit'])) {
  ...
  if ($ac_pass != $ac_pass2) {
      ...
      // code...
        ...
        $add_query = mysqli_query($con,"UPDATE `site_tb` SET  `admin` = '$use_name', `pass` ='$ac_pass', `routing_no` = '$ac_routing' WHERE `admin`='$userid'") or die(mysqli_error($con));
